  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white flex flex-col">
      ...
      <main className="page-content flex-grow">
        ...
        <Header_26 t_prefix="uc6.header_26" />
        <ClientLogos t_prefix="uc2test.scrolling_logos" />
        <Layout_401_AI_Copilot t_prefix="uc6.ai_copilot" />
        <Layout_84 t_prefix="uc6.user_benefits" /> 
        <Layout_401_OfferSteps t_prefix="uc6.offer_steps_headline" />
        <Layout_356 t_prefix="uc6.features" />
        <ConcreteResultsSection t_prefix="uc6.concrete_results" />
        <Team_20 t_prefix="uc6.team_20" />
        <Portfolio_11 t_prefix="uc6.portfolio" />
