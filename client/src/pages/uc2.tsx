...
export default function UC2Page() {
  ...
  const t = {
    ...
    en: {
      ...
      // Solution Section
      solutionTitle: "Your AI co-pilot securing the management of your medium projects",
      ...
      // Results Section
      resultsHeadline: "What our users concretely gain for medium-size tenders",
      resultsSubtitle: "Decisive results for buyers and tender teams",
      card1Title: "Commercial Director or Bid Director",
      card1Subtitle: "Fast decision, enhanced credibility, zero surprises",
      card1Text: "Ensure from day one that every critical clause is identified, every commitment under control, and every risk covered. You walk into the committee with a solid, immediately approvable offer, with no mental load and no unnecessary escalation.",
      card1Point1: "No forgotten clause, no inconsistency detected too late",
      card1Point2: "Go / no-go decision made without delay",
      card1Point3: "Credibility reinforced before top management",
      card2Title: "Proposal Manager, Contract Manager or Project Manager",
      card2Subtitle: "Clear analysis, smooth tracking, zero stress",
      card2Text: "Start on day +1 with a structured and prioritized base generated by AI: every criterion is classified, every sensitive clause detected, every version tracked. You go from being under pressure to being a strategic pilot, able to prove your offer's solidity at any time.",
      card2Point1: "Analysis ready from day one, no manual sorting",
      card2Point2: "No stress, no surprises, no unnecessary back-and-forths",
      card2Point3: "Full control over every clause and every version",
      kpiTime: "50% of initial analysis time",
      kpiClauses: "100% of critical clauses identified",
      kpiSurprise: "0 surprise, no last-minute challenge",
      kpiExtra: "Faster, cleaner, more competitive offer",
      
      // WOW Features
      wowHeadline: "Advanced capabilities that elevate your medium projects",
      wowSubtitle: "Beyond intelligent coordination, discover features that turn medium project management into a competitive advantage.",
      predictiveTitle: "Performance Prediction",
      predictiveText: "Anticipate bottlenecks and automatically optimize resource allocation with advanced predictive analytics.",
      predictiveTag: "AI optimization",
      collaborationTitle: "Adaptive Collaboration",
      collaborationText: "Workspaces that automatically adapt to the size and complexity of each project team for maximum efficiency.",
      collaborationTag: "Dynamic adaptation",
      metricsTitle: "Smart Metrics",
      metricsText: "Adaptive dashboards highlighting the KPIs most relevant to the project's phase and complexity.",
      metricsTag: "Dynamic KPIs",
      risksTitle: "Risk Management",
      risksText: "Proactive risk identification with automatic mitigation suggestions based on similar past projects.",
      risksTag: "AI prevention",
      templatesTitle: "Smart Templates",
      templatesText: "Automatic generation of project structures tailored to complexity, sector, and specific requirements.",
      templatesTag: "AI customization",
      learningTitle: "Continuous Learning",
      learningText: "The system learns from every project to automatically optimize processes and improve future performance.",
      learningTag: "Continuous improvement",
      integrationTitle: "Integrated ecosystem, amplified performance",
      integrationText: "Native connectivity with your existing business tools (ERP, CRM, project management tools) for perfect synergy and unified data.",
      integrationTag1: "Native API",
      integrationTag2: "Real-time sync",
      
      // Reference Projects
      refProjectsHeadline: "Our reference tenders on medium-size projects",
      refProjectsSubtitle: "See how our clients transform their medium projects with Aitenders AI",
      project1Title: "Regional Logistics Center",
      project1Sector: "Logistics",
      project1Offer: "Offer: €8.5 Million",
      project1Desc: "Construction of a modern 25,000 m² logistics hub with automated systems and maneuvering areas. Coordination of 10 specialized technical lots including handling, security and connectivity.",
      project1Productivity: "Productivity: +55% coordination time saved",
      project1Compliance: "Compliance: Logistics standards respected",
      project1Traceability: "Traceability: Multi-lot tracking integrated",
      project1Collaboration: "Collaboration: 10 teams synchronized",
      project2Title: "Urban District Rehabilitation",
      project2Sector: "Urban",
      project2Offer: "Offer: €6.2 Million",
      project2Desc: "Complete renovation of a residential district with 200 housing units, green spaces and shops. Coordinated management of networks, roads and occupancy constraints over 5 hectares.",
      project2Productivity: "Productivity: +62% faster studies",
      project2Compliance: "Compliance: Urban planning validated",
      project2Traceability: "Traceability: Phases coordinated",
      project2Collaboration: "Collaboration: 15 trades involved",
      project3Title: "Modern University Campus",
      project3Sector: "Education",
      project3Offer: "Offer: €4.8 Million",
      project3Desc: "Construction of a 15,000 m² campus with lecture halls, labs and student residences. Integration of digital technologies and collaborative spaces on an 8-hectare site.",
      project3Productivity: "Productivity: +48% time reduction",
      project3Compliance: "Compliance: Academic standards",
      project3Traceability: "Traceability: Continuous validation",
      project3Collaboration: "Collaboration: 18 lots coordinated",
      
      // ROI Simulator
      roiSimulatorBadge: "Integrated ROI Simulator",
      roiSimulatorHeadline: "Calculate your ROI in real time",
      roiSimulatorSubtext: "Smart simulator integrated into the page for immediate analysis of your projects",
