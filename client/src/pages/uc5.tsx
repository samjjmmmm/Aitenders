// client/src/pages/uc5.tsx (FINAL AND CORRECT VERSION)
...
export function UC5() { // Using a named export
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-white">
          ...
          <div className="flex flex-col items-center text-center space-y-8">
            <div className="w-full max-w-5xl px-4">
              <div className="mb-12">
                ...
                <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4" dangerouslySetInnerHTML={{ __html: t('uc5.hero.title') }} />
                <p className="text-lg md:text-xl mb-16 font-light" dangerouslySetInnerHTML={{ __html: t('uc5.hero.description') }} />
              </div>
        ...
        <div className="content-boundary relative z-10">
          <div className="bg-white/95 rounded-3xl p-16 lg:p-20 border border-gray-100/50 mb-20">
            <div className="relative z-10 text-center">
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4" dangerouslySetInnerHTML={{ __html: t('uc5.painPoints.headline') }} />
      ...
      <motion.section 
        ...
        <div className="content-boundary relative z-10">
          <div className="text-center mb-12 md:mb-16">
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4" dangerouslySetInnerHTML={{ __html: t('uc5.solution.mainTitle') }} />
            <h3 className="text-lg md:text-xl text-gray-600 max-w-4xl mx-auto">{t('uc5.solution.subtitle')}</h3>
          </div>
          {/* Feature 1 */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h3 className="text-2xl font-bold mb-4" dangerouslySetInnerHTML={{ __html: t('uc5.solution.feature1.title') }} />
              <p className="text-xl text-gray-600 mb-8" dangerouslySetInnerHTML={{ __html: t('uc5.solution.feature1.description') }} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="order-1 lg:order-2">
              <h3 className="text-2xl font-bold mb-4" dangerouslySetInnerHTML={{ __html: t('uc5.solution.feature2.title') }} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <h3 className="text-2xl font-bold mb-4" dangerouslySetInnerHTML={{ __html: t('uc5.solution.feature3.title') }} />
              <div className="text-xl text-gray-600 mb-8" dangerouslySetInnerHTML={{ __html: t('uc5.solution.feature3.description') }} />
      ...
      <motion.section initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }} className="py-16 md:py-20 px-4 bg-gradient-to-br from-indigo-900 via-purple-900 to-blue-900 relative">
        <div className="content-boundary relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6" dangerouslySetInnerHTML={{ __html: t('uc5.toppings.headline') }} />
      ...
      <motion.section initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }} className="py-16 md:py-20 px-4 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
        <div className="content-boundary">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6" dangerouslySetInnerHTML={{ __html: t('uc5.projects.headline') }} />
