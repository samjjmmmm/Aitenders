        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">-50% à -70%</h3>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-xl font-bold text-purple-600">Sérénité</span>
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Sérénité maximale</h3>
              <p className="text-gray-600">Process automatisé</p>
            </div>
          </div>
        </div>
      </section>
