  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-white">
          ...
          <div ref={(el) => registerElement('hero-main', el)} data-scroll-id="hero-main" className={`text-center transition-all duration-1000 ${visibleElements.has('hero-main') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="max-w-5xl mx-auto">
              <div ref={(el) => registerElement('hero-content', el)} data-scroll-id="hero-content" className={`mb-16 transition-all duration-1000 delay-200 ${visibleElements.has('hero-content') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                <Badge className="mb-8 bg-gradient-to-r from-purple-50 to-purple-100/80 text-purple-800 border-purple-200/50 text-lg font-semibold px-6 py-3 rounded-full shadow-sm">{t('hero.badge')}</Badge>
                <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 md:mb-6 leading-[1.1] tracking-tight">
                  <Trans i18nKey="hero.title" t={t} components={{ span: <span className="text-purple-600" /> }} />
                </h1>
                <p className="text-lg md:text-xl mb-16 leading-relaxed font-light text-[#000000]">
                  <Trans i18nKey="hero.description" t={t} components={{ span: <span className="text-purple-300" />, 'span-bold': <span className="text-purple-bold600" /> }} />
                </p>
              </div>
            ...
            <div ref={(el) => registerElement('main-feature-card', el)} data-scroll-id="main-feature-card" className={`bg-white/95 backdrop-blur-sm rounded-3xl p-16 lg:p-20 border border-gray-100/50 relative overflow-hidden mb-20 transition-all duration-1000 delay-300 ${visibleElements.has('main-feature-card') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`} style={{ boxShadow: '0 32px 64px -12px rgba(0, 0, 0, 0.12), 0 0 0 1px rgba(255, 255, 255, 0.05)' }}>
              ...
              <div className="relative z-10 text-center">
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 md:mb-6 leading-[1.1] tracking-tight">
                  <Trans i18nKey="painPoints.headline" t={t} components={{ span: <span className="text-purple-600" /> }} />
                </h2>
                <p className="text-xl text-gray-600 leading-relaxed mb-8 font-light">
                  <Trans i18nKey="painPoints.text1" t={t} components={{ span: <span className="text-grey-500 font-bold" /> }} />
                </p>
        ...
        <div ref={(el) => registerElement('solution-section', el)} data-scroll-id="solution-section" className={`transition-all duration-1000 ${visibleElements.has('solution-section') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="content-boundary relative z-10">
            <div ref={(el) => registerElement('solution-header', el)} data-scroll-id="solution-header" className={`text-center mb-12 md:mb-16 lg:mb-20 transition-all duration-1000 delay-200 ${visibleElements.has('solution-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 md:mb-6 leading-[1.1] tracking-tight">
                <Trans i18nKey="solution.mainTitle" t={t} components={{ span: <span className="text-purple-600" /> }} />
              </h1>
            ...
            <div ref={(el) => registerElement('feature-1', el)} data-scroll-id="feature-1" className={`grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 lg:gap-20 items-center mb-16 md:mb-20 lg:mb-24 transition-all duration-1000 delay-400 ${visibleElements.has('feature-1') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>
              <div className="order-1 pr-4 lg:pr-8">
                <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 md:mb-6 leading-[1.1] tracking-tight"><Trans i18nKey="solution.feature1.title" t={t} components={{ span: <span className="text-purple-600" /> }} /></h3>
                <div className="text-xl text-gray-600 leading-relaxed mb-8 font-light">
                  <Trans i18nKey="solution.feature1.text" t={t} components={{ p: <p />, span: <span className="text-purple-600" /> }} />
                </div>
                <div className="flex items-center text-lg font-bold text-blue-500">
                  <MdCheckCircle className="w-6 h-6 mr-3 text-green-500" />{t('solution.feature1.highlight')}
                </div>
              </div>
            ...
            <div ref={(el) => registerElement('feature-2', el)} data-scroll-id="feature-2" className={`grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 lg:gap-20 items-center mb-16 md:mb-20 lg:mb-24 transition-all duration-1000 delay-600 ${visibleElements.has('feature-2') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}>
              ...
              <div className="order-1 lg:order-2 pl-4 lg:pl-8">
                <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 md:mb-6 leading-[1.1] tracking-tight"><Trans i18nKey="solution.feature2.title" t={t} components={{ span: <span className="text-purple-600" /> }} /></h3>
                <div className="text-xl text-gray-600 leading-relaxed mb-8 font-light">
                  <Trans i18nKey="solution.feature2.text" t={t} components={{ p: <p />, span: <span className="text-purple-600" /> }} />
                </div>
                <div className="flex items-center text-lg text-gray-500">
                  <MdCheckCircle className="w-6 h-6 mr-3 text-green-500" /><span className="font-bold text-blue-500">{t('solution.feature2.highlight')}</span>
                </div>
              </div>
            </div>
            {/* Feature 3 */}
            <div ref={(el) => registerElement('feature-3', el)} data-scroll-id="feature-3" className={`grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 lg:gap-20 items-center transition-all duration-1000 delay-800 ${visibleElements.has('feature-3') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>
              <div className="order-1 pr-4 lg:pr-8">
                <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 md:mb-6 leading-[1.1] tracking-tight"><Trans i18nKey="solution.feature3.title" t={t} components={{ span: <span className="text-purple-600" /> }} /></h3>
                <div className="text-xl text-gray-600 leading-relaxed mb-8 font-light">
                  <Trans i18nKey="solution.feature3.text" t={t} components={{ p: <p />, span: <span className="text-purple-600" /> }} />
                </div>
                <div className="flex items-center text-lg font-bold text-blue-500">
                  <MdCheckCircle className="w-6 h-6 mr-3 text-green-500" />{t('solution.feature3.highlight')}
                </div>
              </div>
              ...
              <div className="group">
                <Card className="h-full p-8 bg-gradient-to-br from-purple-50 to-indigo-50 border border-purple-200/50 hover:border-purple-300/50 transition-all duration-300 hover:shadow-xl transform hover:-translate-y-1">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h4 className="text-xl font-bold text-gray-900">{t('results.card1.title')}</h4>
                      <p className="text-sm text-gray-600">{t('results.card1.subtitle')}</p>
                    </div>
                  </div>
                  <p className="text-gray-700 text-base leading-relaxed mb-4">{t('results.card1.text')}</p>
                  <ul className="text-gray-600 text-sm leading-relaxed space-y-2">
                    <li className="flex items-start"><span className="inline-block w-1.5 h-1.5 bg-purple-500 rounded-full mt-2 mr-3 flex-shrink-0"></span><span>{t('results.card1.benefit1')}</span></li>
                    <li className="flex items-start"><span className="inline-block w-1.5 h-1.5 bg-purple-500 rounded-full mt-2 mr-3 flex-shrink-0"></span><span>{t('results.card1.benefit2')}</span></li>
                    <li className="flex items-start"><span className="inline-block w-1.5 h-1.5 bg-purple-500 rounded-full mt-2 mr-3 flex-shrink-0"></span><span>{t('results.card1.benefit3')}</span></li>
                    <li className="flex items-start"><span className="inline-block w-1.5 h-1.5 bg-purple-500 rounded-full mt-2 mr-3 flex-shrink-0"></span><span>{t('results.card1.benefit4')}</span></li>
                  </ul>
                </Card>
              </div>
              <div className="group">
                <Card className="h-full p-8 bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200/50 hover:border-green-300/50 transition-all duration-300 hover:shadow-xl transform hover:-translate-y-1">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h4 className="text-xl font-bold text-gray-900">{t('results.card2.title')}</h4>
                      <p className="text-sm text-gray-600">{t('results.card2.subtitle')}</p>
                    </div>
                  </div>
                  <p className="text-gray-700 text-base leading-relaxed mb-4">{t('results.card2.text')}</p>
                  <div className="text-gray-600 text-sm leading-relaxed space-y-2">
                    <div className="flex items-start"><div className="w-1.5 h-1.5 bg-green-500 rounded-full mr-3 mt-2 flex-shrink-0"></div><span>{t('results.card2.benefit1')}</span></div>
                    <div className="flex items-start"><div className="w-1.5 h-1.5 bg-green-500 rounded-full mr-3 mt-2 flex-shrink-0"></div><span>{t('results.card2.benefit2')}</span></div>
                    <div className="flex items-start"><div className="w-1.5 h-1.5 bg-green-500 rounded-full mr-3 mt-2 flex-shrink-0"></div><span>{t('results.card2.benefit3')}</span></div>
                    <div className="flex items-start"><div className="w-1.5 h-1.5 bg-green-500 rounded-full mr-3 mt-2 flex-shrink-0"></div><span>{t('results.card2.benefit4')}</span></div>
                  </div>
                </Card>
              </div>
            </div>
        ...
        <div ref={(el) => registerElement('toppings-section', el)} data-scroll-id="toppings-section" className={`transition-all duration-1000 ${visibleElements.has('toppings-section') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="content-boundary relative z-10">
            <div ref={(el) => registerElement('toppings-header', el)} data-scroll-id="toppings-header" className={`text-center mb-16 md:mb-20 lg:mb-24 transition-all duration-1000 delay-200 ${visibleElements.has('toppings-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 md:mb-8 leading-[1.1] tracking-tight"><Trans i18nKey="toppings.headline" t={t} components={{ span: <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-pink-400 to-cyan-400" /> }} /></h2>
      ...
      <section className="py-16 md:py-20 lg:py-24 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
        <div ref={(el) => registerElement('projects-section', el)} data-scroll-id="projects-section" className={`content-boundary transition-all duration-1000 ${visibleElements.has('projects-section') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div ref={(el) => registerElement('projects-header', el)} data-scroll-id="projects-header" className={`text-center mb-12 md:mb-16 lg:mb-20 transition-all duration-1000 delay-200 ${visibleElements.has('projects-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 md:mb-8 leading-[1.1] tracking-tight"><Trans i18nKey="projects.headline" t={t} components={{ span: <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-600" /> }} /></h2>
            <p className="text-lg md:text-xl text-gray-600 max-w-4xl mx-auto">{t('projects.subtitle')}</p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-10 mb-16 md:mb-20">
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }} className="group">
              <div className="bg-white rounded-3xl p-8 shadow-lg h-full"><h3 className="text-2xl font-bold text-gray-900 mb-3">{t('projects.project1.title')}</h3><div className="mb-4"><Badge className="bg-purple-100 text-purple-800 font-medium">{t('projects.project1.badge')}</Badge></div><div className="text-xl font-bold text-purple-600 mb-4">{t('projects.project1.offer')}</div><p className="text-gray-600 leading-relaxed mb-6">{t('projects.project1.description')}</p><div className="space-y-3"><h4 className="font-semibold text-gray-900 mb-3">{t('projects.impactLabel')}</h4>
                <div><Trans i18nKey="projects.project1.impact1" t={t} components={{ strong: <strong /> }} /></div>
                <div><Trans i18nKey="projects.project1.impact2" t={t} components={{ strong: <strong /> }} /></div>
                <div><Trans i18nKey="projects.project1.impact3" t={t} components={{ strong: <strong /> }} /></div>
                <div><Trans i18nKey="projects.project1.impact4" t={t} components={{ strong: <strong /> }} /></div>
              </div></div>
            </motion.div>
            {/* Project 2 */}
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="group">
              <div className="bg-white rounded-3xl p-8 shadow-lg h-full"><h3 className="text-2xl font-bold text-gray-900 mb-3">{t('projects.project2.title')}</h3><div className="mb-4"><Badge className="bg-blue-100 text-blue-800 font-medium">{t('projects.project2.badge')}</Badge></div><div className="text-xl font-bold text-blue-600 mb-4">{t('projects.project2.offer')}</div><p className="text-gray-600 leading-relaxed mb-6">{t('projects.project2.description')}</p><div className="space-y-3"><h4 className="font-semibold text-gray-900 mb-3">{t('projects.impactLabel')}</h4>
                <div><Trans i18nKey="projects.project2.impact1" t={t} components={{ strong: <strong /> }} /></div>
                <div><Trans i18nKey="projects.project2.impact2" t={t} components={{ strong: <strong /> }} /></div>
                <div><Trans i18nKey="projects.project2.impact3" t={t} components={{ strong: <strong /> }} /></div>
                <div><Trans i18nKey="projects.project2.impact4" t={t} components={{ strong: <strong /> }} /></div>
              </div></div>
            </motion.div>
            {/* Project 3 */}
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }} className="group">
              <div className="bg-white rounded-3xl p-8 shadow-lg h-full"><h3 className="text-2xl font-bold text-gray-900 mb-3">{t('projects.project3.title')}</h3><div className="mb-4"><Badge className="bg-green-100 text-green-800 font-medium">{t('projects.project3.badge')}</Badge></div><div className="text-xl font-bold text-green-600 mb-4">{t('projects.project3.offer')}</div><p className="text-gray-600 leading-relaxed mb-6">{t('projects.project3.description')}</p><div className="space-y-3"><h4 className="font-semibold text-gray-900 mb-3">{t('projects.impactLabel')}</h4>
                <div><Trans i18nKey="projects.project3.impact1" t={t} components={{ strong: <strong /> }} /></div>
                <div><Trans i18nKey="projects.project3.impact2" t={t} components={{ strong: <strong /> }} /></div>
                <div><Trans i18nKey="projects.project3.impact3" t={t} components={{ strong: <strong /> }} /></div>
                <div><Trans i18nKey="projects.project3.impact4" t={t} components={{ strong: <strong /> }} /></div>
              </div></div>
            </motion.div>
          </div>
          ...
          <div ref={(el) => registerElement('simulator-section', el)} data-scroll-id="simulator-section" className={`bg-gradient-to-br from-purple-50 via-white to-blue-50 rounded-3xl shadow-2xl border border-purple-100 p-8 md:p-12 relative overflow-hidden transition-all duration-1000 delay-800 ${visibleElements.has('simulator-section') ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
            <div className="relative z-10">
              <div className="text-center mb-8">
                <div className="inline-flex items-center justify-center px-6 py-3 bg-purple-100 rounded-full border border-purple-200 mb-6"><MdAnalytics className="w-5 h-5 text-purple-600 mr-2" /><span className="text-purple-700 font-semibold text-sm">{t('roi.badge')}</span></div>
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4"><Trans i18nKey="roi.headline" t={t} components={{ span: <span className="text-purple-600" /> }} /></h3>
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">{t('roi.subtitle')}</p>
              </div>
      ...
      <ChatInterface
        ...
        transparent={true}
        customActions={[
          { label: t('chat.action1'), icon: <span className="text-gray-400">+</span>, onClick: () => {} },
          { label: t('chat.action2'), icon: <MdPlayArrow className="w-3 h-3 text-gray-400" />, onClick: () => {} },
          { label: t('chat.action3'), icon: <MdAnalytics className="w-3 h-3 text-gray-400" />, onClick: () => {} },
          { label: t('chat.action4'), icon: <MdMail className="w-3 h-3 text-gray-400" />, onClick: () => {} }
        ]}
      />
