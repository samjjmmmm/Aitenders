...
export default function Header({ language = 'fr', onLanguageChange }: HeaderProps) {
  ...
  return (
    <header className="relative z-50 bg-aitenders-white-blue/80 backdrop-blur-sm border-b border-aitenders-light-blue">
      ...
      {isMenuOpen && (
        <div className="fixed top-0 right-0 h-full w-80 bg-white shadow-2xl transform translate-x-0 transition-transform duration-300 ease-in-out z-50 animate-in slide-in-from-right border-l border-gray-200">
        <div className="p-6">
