...
import styles from '../styles/Layout_401.module.css'; // Uses the common Layout_401.module.css

export default function Layout_401_OfferSteps() {
  return (
    <div className={styles.Layout_401_9254_443}> {/* Specific class for this section */}
      <div className={styles.SectionTitle_9253_31701}>
        <div className={styles.Content_9253_31704}><span className={styles.Heading_9253_31705}>Nous accompagnons les équipes à chaque étape de l’offre</span></div>
      </div>
    </div>
  );
}```
...
#### **2. `src/components/Layout_356.tsx`**
*(This component is for the large feature section with "Structuration automatique du projet," "Contrôlez chaque clause critique," and "Maîtrisez chaque évolution contractuelle." It uses its own `Layout_356.module.css`)*
      ...
      <div className={styles.FeatureOne_9238_561}>
        <div className={styles.Container_9238_562}>
          <div className={styles.Content_9238_566}>
            ...
            <div className={styles.PlaceholderImage_9238_576}></div> {/* Replace with actual image URL */}
          </div>
        </div>
      </div>
      <div className={styles.FeatureTwo_9238_577}>
        <div className={styles.Container_9238_578}>
          <div className={styles.Content_9238_582}>
            <div className={styles.PlaceholderImage_9238_583}></div> {/* Replace with actual image URL */}
      ...
      <div className={styles.FeatureThree_9238_593}>
        <div className={styles.Container_9238_594}>
          <div className={styles.Content_9238_598}>
            ...
            <div className={styles.PlaceholderImage_9238_608}></div> {/* Replace with actual image URL */}
          </div>
        </div>
      </div>
    </div>
