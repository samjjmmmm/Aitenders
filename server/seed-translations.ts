...
const uc2TranslationKeys = {
  ...
  'uc2.painPoints.text1': 'En proyectos medianos, sus equipos hacen malabarismos entre plazos ajustados, cláusulas críticas ocultas y versiones dispersas, con riesgo de errores costosos y vaivenes interminables.',
  'uc2.painPoints.text2': 'Con Aitenders, estructure automáticamente cada expediente desde el día 1, detecte instantáneamente las cláusulas sensibles y gestione sus Q&A y versiones en un cockpit centralizado. Resultado: análisis dos veces más rápido, cero cláusula olvidada, y una oferta competitiva validada sin estrés.',
  'uc2.painPoints.optimizeButton': '¡Optimice Sus Proyectos Medianos!',
  'uc2.painPoints.demoButton': 'Ver la Demostración',

  'uc2.pain_points.title1': 'Plazos ajustados y requisitos complejos',
  'uc2.pain_points.description1': 'Los proyectos medianos combinan complejidad documental y limitaciones temporales, creando estrés permanente en los equipos',
  'uc2.pain_points.title2': 'Coordinación difícil entre equipos',
  'uc2.pain_points.description2': 'La multiplicidad de intervinientes complica la coherencia y completitud de las respuestas',
  'uc2.pain_points.title3': 'Riesgos de no conformidad elevados',
  'uc2.pain_points.description3': 'Olvidos y errores de cumplimiento pueden descalificar instantáneamente las mejores propuestas',

  'uc2.solution_section.mainTitle': 'Su copiloto IA que asegura la gestión de sus proyectos medianos',
  'uc2.solution_section.subtitle': 'Descubra, gestione y asegure cada cláusula desde el primer día.',
  'uc2.solution_section.feature1_title': 'Estructuración automática del perímetro desde el primer día',
  'uc2.solution_section.feature1_text': 'La IA de Aitenders analiza instantáneamente sus documentos de licitación y estructura automáticamente el perímetro, identifica los lotes, detecta las interfaces críticas y mapea cada requisito. Sus equipos comienzan con una visión clara y completa del proyecto.',
  'uc2.solution_section.feature1_highlight': 'Su cockpit de proyecto operacional desde D+1',
  'uc2.solution_section.feature2_title': 'Controle cada cláusula crítica en tiempo real',
  'uc2.solution_section.feature2_text': 'Aitenders supervisa y analiza continuamente cada cláusula sensible: penalizaciones, responsabilidades, plazos críticos y condiciones particulares. Cada modificación es trazada, cada impacto evaluado automáticamente.',
  ...
  'uc2.toppings.features.predictive.text': 'Anticipación automática de riesgos contractuales y recomendaciones de mitigación basadas en historial e inteligencia colectiva.',
  'uc2.toppings.features.predictive.tag': 'Análisis Predictivo',

  'uc2.toppings.features.collaboration.title': 'Colaboración adaptativa multi-equipos',
  'uc2.toppings.features.collaboration.text': 'Orquestación inteligente de las contribuciones de cada experto de negocio con sincronización automática y resolución de conflictos.',
  'uc2.toppings.features.collaboration.tag': 'Colaboración Inteligente',

  'uc2.toppings.features.metrics.title': 'Métricas inteligentes de rendimiento',
  'uc2.toppings.features.metrics.text': 'Tableros adaptativos con KPIs personalizados según su contexto de proyecto y benchmarks sectoriales automáticos.',
  'uc2.toppings.features.metrics.tag': 'Analytics Avanzados',

  'uc2.toppings.features.risks.title': 'Gestión proactiva de riesgos complejos',
  'uc2.toppings.features.risks.text': 'Detección automática de riesgos sistémicos y cascada de impactos con planes de mitigación sugeridos y pruebas de estrés automáticas.',
  'uc2.toppings.features.risks.tag': 'Risk Management',

  'uc2.toppings.features.templates.title': 'Templates inteligentes evolutivos',
  'uc2.toppings.features.templates.text': 'Biblioteca de templates auto-aprendizaje que se adaptan a sus sectores y evolucionan según sus comentarios.',
  'uc2.toppings.features.templates.tag': 'Smart Templates',

  'uc2.toppings.features.learning.title': 'Aprendizaje continuo y optimización',
  'uc2.toppings.features.learning.text': 'La IA aprende de cada proyecto para optimizar procesos futuros y proponer mejoras continuas basadas en sus éxitos.',
  'uc2.toppings.features.learning.tag': 'Machine Learning',

  'uc2.toppings.features.integration.title': 'Ecosistema integrado, rendimiento mejorado',
  'uc2.toppings.features.integration.text': 'Conectividad nativa con sus herramientas empresariales existentes para sinergia perfecta y flujo de trabajo unificado.',
  'uc2.toppings.features.integration.tag1': 'API Nativa',
  'uc2.toppings.features.integration.tag2': 'Sincronización Tiempo Real',

  'uc2.toppings.bottom_text': 'Cada funcionalidad optimiza sus proyectos medianos para máximo rendimiento',
  'uc2.toppings.cta': 'Explorar todas las funcionalidades →',

  'uc2.reference_projects.headline': 'Nuestras licitaciones de referencia para proyectos medianos',
  'uc2.reference_projects.subtitle': 'Descubra cómo nuestros clientes transforman sus proyectos medianos con IA Aitenders',
  ...
  'uc2.reference_projects.project1.desc': 'Construcción y equipamiento de un centro logístico automatizado de 25.000 m² con sistemas de clasificación y gestión de flujos.',
  'uc2.reference_projects.project1.impact.productivity': 'Productividad +40%, plazos respetados',
  'uc2.reference_projects.project1.impact.compliance': 'Cumplimiento 100%, riesgos controlados',
  'uc2.reference_projects.project1.impact.traceability': 'Trazabilidad completa, auditoría facilitada',
  'uc2.reference_projects.project1.impact.collaboration': 'Colaboración fluida, equipos alineados',

  'uc2.reference_projects.project2.title': 'Rehabilitación Barrio Urbano',
  'uc2.reference_projects.project2.sector': 'Urbanismo',
  'uc2.reference_projects.project2.offer': 'Oferta: 18,2 M€',
  'uc2.reference_projects.project2.desc': 'Renovación urbana completa con viviendas, espacios verdes e infraestructura conectada para 500 familias.',
  'uc2.reference_projects.project2.impact.productivity': 'Productividad +45%, coordinación optimizada',
  'uc2.reference_projects.project2.impact.compliance': 'Cumplimiento 100%, validación automática',
  'uc2.reference_projects.project2.impact.traceability': 'Trazabilidad tiempo real, reporting automatizado',
  'uc2.reference_projects.project2.impact.collaboration': 'Sinergias de equipos, comunicación fluida',
  ...
  'uc2.reference_projects.project3.impact.compliance': 'Cumplimiento 100%, normas respetadas',
  'uc2.reference_projects.project3.impact.traceability': 'Trazabilidad integral, seguimiento de calidad',
  'uc2.reference_projects.project3.impact.collaboration': 'Coordinación perfecta, objetivos alcanzados',

  'uc2.roi_simulator.badge': 'Simulador ROI Integrado',
  'uc2.roi_simulator.headline': 'Calcule su ROI en tiempo real',
  'uc2.roi_simulator.subtext': 'Simulador inteligente integrado en la página para análisis inmediato de sus proyectos medianos',
...
const specificUITranslations = {
  ...
  'simulator.description': '📊 **SIMULADOR ROI AITENDERS PARA SUS NECESIDADES**\n\n⏱️ Tiempo estimado: 3-5 minutos\n📧 Recibirá su informe detallado por correo electrónico\n\n---\n\n**Pregunta 1/4: Volumen y Tipos de Proyectos**\n\nPara calcular mejor su ROI, ¿puede describir el volumen de proyectos a los que se postula anualmente?\n\n**📋 Ejemplos de respuestas:**\n• "100 proyectos pequeños de unos 5M€"\n• "50 proyectos medianos de 20M€"\n• "5 proyectos grandes de 100M€"\n\n💡 **Puede responder en lenguaje natural.**',
  'simulator.processing': 'Procesando...',
  'simulator.helpText': '💡 Puede responder en lenguaje natural o utilizar los formatos sugeridos',
...
const allUCSpanishTranslations = {
  ...
  'uc1.features.project_chat.description': 'Asistente IA conversacional que responde preguntas sobre el proyecto en tiempo real con referencias a fuentes.',
