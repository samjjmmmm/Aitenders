...
const uc2SpanishTranslations = {
  ...
  'client.subtitle': 'Únete a las empresas líderes que confían en Aitenders para su gestión de licitaciones',
};
...
const uc2GermanTranslations = {
  ...
  'client.subtitle': 'Schließen Sie sich führenden Unternehmen an, die Aitenders für ihr Ausschreibungsmanagement vertrauen',
};
